...
public class JSONObjectProcessor {
	...
	public static void main(String args[]) {
		...
		try {
			Object obj = parser.parse(new FileReader(
					"C:\\Noushad\\rnd\\resumeparser\\code4goal-resume-parser-master\\c4g v2\\compiled\\178863526Nancy Buan CV.doc.json"));
	...
	public User returnProcessedUser(JSONObject jsonObject) {
		...
		try {
			...
			// FileReader("C:\\Noushad\\rnd\\resumeparser\\code4goal-resume-parser-master\\c4g
			// v2\\compiled\\178863526Nancy Buan CV.doc.json"));
			// JSONObject jsonObject =(JSONObject) obj;
			u = new User();
			// String name = jsonObject.get("firstName") == null? "":
			// jsonObject.get("firstName").toString() + " "+ jsonObject.get("lastName") ==
			// null? "": jsonObject.get("lastName").toString() ;
			...
			u.setIsAdmin(jsonObject.get("capabilities.isAdmin") == null ? ""
					: jsonObject.get("capabilities.isAdmin").toString());
			...
			u.setCompanypostcode(
					jsonObject.get("companypostcode") == null ? "" : jsonObject.get("companypostcode").toString());
			u.setCompanyaddress1(
			...
			// u.setUserName(jsonObject.get("username") == null? "":
			// jsonObject.get("username").toString());
			log.debug(" Returning user :>" + u.getUserName());
			return u;
