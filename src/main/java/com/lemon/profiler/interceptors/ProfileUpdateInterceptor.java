...
public class ProfileUpdateInterceptor extends AbstractInterceptor {
	...
	private static final Logger log = Logger
			.getLogger(ProfileUpdateInterceptor.class);
		
	@Override
	public String intercept(ActionInvocation invocation) throws Exception {
		log.info("ProfileUpdateInterceptor triggered");
		...
		if (loginId == null) {
			...
			log.info("User :"+loginId +" found without organization , redirecting to update the profile");
			addActionError(invocation, "You must update your organization details before proceeding!");
			return "updateProfile";
		}else {
			log.info("ProfileUpdateInterceptor clearing the path.. as is identified as : "+organization+ " for :: "+loginId);
