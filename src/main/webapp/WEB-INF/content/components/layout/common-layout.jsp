...
<body>
	...
	<div id="pviewer" class="pviewer">
		...
		<iframe id="preview" name="pdfpreview" width="850" height="625"
	...
	<script type="text/javascript"
		src="<s:url value="/js/chartjs272/Chart.min.js"/>"></script>
	<script type="text/javascript"
		src="<s:url value="/js/profileRcommon.js"/>"></script>
