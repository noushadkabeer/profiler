...
<head>
 ...
 <link href="<s:url value="/css/_all-skins.min.css"/>" rel="stylesheet" type="text/css" />
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-mini"><b>HR</b>RP</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>HR</b>Resume</span>
    </a>
...
<!-- iCheck -->
<script  type="text/javascript" src="<s:url value="/js/icheck.min.js"/>"></script> 
<!-- SlimScroll -->
<script  type="text/javascript" src="<s:url value="/js/slimScroll/jquery.slimscroll.min.js"/>"></script>
<!-- FastClick -->
<script  type="text/javascript" src="<s:url value="/js/fastclick/fastclick.js"/>"></script>
<!-- AdminLTE App -->
<script  type="text/javascript" src="<s:url value="/js/adminlte/app.min.js"/>"></script>
<!-- AdminLTE for demo purposes -->
<script  type="text/javascript" src="<s:url value="/js/adminlte/demo.js"/>"></script>
</body>
</html>
